<nav class="navbar navbar-main navbar-expand-lg px-0 mx-3 shadow-none border-radius-xl" id="navbarBlur"
    ...
    <div class="container-fluid py-1 px-3">
        ...
        <div class="collapse navbar-collapse d-flex justify-content-end" id="navbar">
            <ul class="mt-2 navbar-nav d-flex align-items-center justify-content-end">
                ...
                <li class="nav-item dropdown pe-3 d-flex align-items-center">
                    <a href="javascript:;" class="nav-link text-body p-0 d-flex align-items-center gap-1 mb-1"
                        id="dropdownMenuButton" data-bs-toggle="dropdown" aria-expanded="false">
                        <i class="material-symbols-rounded">account_circle</i><span> {{ Auth::user()->name }}</span>
                    </a>
                    <ul class="dropdown-menu  dropdown-menu-end  px-2 py-3 me-sm-n4"
                        aria-labelledby="dropdownMenuButton">
                        <li class="mb-2">
                            <x-responsive-nav-link :href="route('profile.edit')"
                                ...
                                <h6 class="text-sm font-weight-normal mb-1 mx-3">
                        ...
                        <li class="mb-2">
                            <form method="POST" action="{{ route('logout') }}">
                                ...
                                <x-responsive-nav-link :href="route('logout')"
                                    ...
                                    <h6 class="text-sm font-weight-normal mb-1 mx-2">
                                        <span class="text-sm font-weight-bold">{{ __('Log out') }}</span>
                                    </h6>
                                </x-responsive-nav-link>
                            </form>
                        </li>
